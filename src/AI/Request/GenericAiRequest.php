 ...
 */
class GenericAiRequest implements AiRequestInterface
{
	...
	/**
	 * Nastaví GET parametry (budou součástí URL)
	 */
	 ...
	 */
	public function withBodyParams(array $params): static
	{
	...
	/**
	 * @deprecated Použij withQueryParams nebo withBodyParams
	 */
	public function withParameters(array $parameters): static
	{
		$this->bodyParams = array_merge($this->bodyParams, $parameters);
		return $this;
	}
